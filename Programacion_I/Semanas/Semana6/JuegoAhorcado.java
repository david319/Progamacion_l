...
public class JuegoAhorcado {
    ...
    public static void main(String[] args) {
        ...
        while (true) { // bucle infinito
            ...
            String[] palabras = new String[7]; // array de palabras
            palabras[0] = "cuidar";
            palabras[1] = "azulejo";
            palabras[2] = "copa";
            palabras[3] = "zapato";
            ...
            System.out.println("¿Desea jugar de nuevo? (s/n)"); // Preguntamos si desea jugar de nuevo
            String respuesta = leer.next();
            if (respuesta.equals("n")) { // Si la respuesta es n
                System.out.println("Gracias por jugar");
                for (String i :palabras) { // Recorremos el array de palabras
